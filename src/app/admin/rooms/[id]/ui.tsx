...
export default function EditRoom({ room }: { room: any }) {
    ...
    <div className="mx-auto max-w-2xl px-6 py-8">
      ...
      <form onSubmit={onSave} className="mt-6 space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <form
            action={`/admin/rooms/${room.id}/delete`}
            method="post"
            onSubmit={(e) => {
              if (!confirm("Delete this room?")) e.preventDefault();
            }}
          >
            <button className="rounded-lg px-4 py-2 bg-rose-600 text-white hover:bg-rose-500">Delete</button>
          </form>
        </div>
      </form>
    </div>
